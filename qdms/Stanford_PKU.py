...
class Stanford_PKU(Memristor):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.E_a = E_a
        self.a_0 = a_0
        self.delta_g_init = delta_g_init
    ...
    def plot_hysteresis_loop(self, duration=0.5, voltage_signal_amplitude=1.5, voltage_signal_frequency=10,
                             log_scale=False, return_result=False, **kwargs):
    ...
    def plot_bipolar_switching_behaviour(self, voltage_signal_amplitude=1.5, voltage_signal_frequency=0.05,
                                         log_scale=True, return_result=False, **kwargs):
